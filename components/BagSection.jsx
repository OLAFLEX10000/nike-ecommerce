...
import { bagProducts } from '../data/product';
  ...
  return (
    <section className="bg-white py-12 text-black">
      <div className="w-full bg-neutral-100 py-10 px-4 shadow-2xl rounded-xl">
                      <div>
                        <h3 className="text-3xl lg:text-4xl font-bold mb-8 text-start tracking-tight">
                          Bag <span className="text-red-600">Essentials</span>
                        </h3>
                      </div>
            ...
                                className="flex-grow max-h-3/4 bg-neutral-200 rounded-lg flex items-center justify-center relative z-10 p-2"
                              >
                                <img
                                  src={product.image}
                                  alt={product.name}
